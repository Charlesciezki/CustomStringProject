...
//Create a System.Collections.SortedList, SortedList<ICustomString> sortedStringList, sorted by the length of each string element, 
//populated by a mix of each of the ICustomString subclasses
//Using a Systems.Collections.Generic.Dictionary as an underlying structure, create a Sweepstakes class with the 
//following functions(you will need to define a Contestant class containing appropriate fields for the purpose):
